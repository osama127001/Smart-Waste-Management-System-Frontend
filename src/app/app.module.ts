...
import { AddCoordinatesComponent } from './auth/signup/add-coordinates/add-coordinates.component';
...
@NgModule({
  ...
  entryComponents: [AddAdminComponent, AddDustbinComponent, AddDriverComponent, AddCoordinatesComponent]
})
